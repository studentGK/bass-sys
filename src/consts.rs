...
/// Access denied (added in 2.4.17).
pub const BASS_ERROR_DENIED: c_int = 49;
/// Being freed — a locked channel is still waiting to be freed (added in 2.4.17).
pub const BASS_ERROR_FREEING: c_int = 50;
/// Operation was cancelled (added in 2.4.17; e.g. BASS_StreamCancel).
pub const BASS_ERROR_CANCEL: c_int = 51;
...
// NOTE: BASS_CONFIG_VISTA_TRUEPOS (30) removed — not present in bass.h 2.4.17+.
pub const BASS_CONFIG_IOS_SESSION: DWORD = 34;
pub const BASS_CONFIG_IOS_MIXAUDIO: DWORD = 34; // alias
...
/// Renamed from BASS_CONFIG_MF_VIDEO in 2.4.17+ (now applies to all video formats).
pub const BASS_CONFIG_VIDEO: DWORD = 48;
pub const BASS_CONFIG_MF_VIDEO: DWORD = BASS_CONFIG_VIDEO; // backward-compat alias
...
// NOTE: BASS_CONFIG_DEV_TIMEOUT (70) removed — not present in bass.h 2.4.17+.
pub const BASS_CONFIG_NET_META: DWORD = 71;
pub const BASS_CONFIG_NET_RESTRATE: DWORD = 72;
/// Enable a "Default" recording device on Windows/macOS (added in 2.4.17).
pub const BASS_CONFIG_REC_DEFAULT: DWORD = 73;
/// Disable volume ramping globally (added in 2.4.17).
pub const BASS_CONFIG_NORAMP: DWORD = 74;
pub const BASS_CONFIG_NOSOUND_MAXDELAY: DWORD = 76;
/// Stack allocation size for internal processing (added in 2.4.17).
pub const BASS_CONFIG_STACKALLOC: DWORD = 79;
/// Downmix multi-channel to mono/stereo on output; set to 0 to disable.
/// Default changed to enabled in 2.4.18 (added in 2.4.17).
...
/// Android JVM pointer (added in 2.4.17).
pub const BASS_CONFIG_ANDROID_JAVAVM: DWORD = 63;
pub const BASS_CONFIG_LIBSSL: DWORD = 64;
/// Custom filename for next file-open (added in 2.4.17).
pub const BASS_CONFIG_FILENAME: DWORD = 75;
/// Custom file-open procedure table (BASS_FILEOPENPROCS; added in 2.4.17).
pub const BASS_CONFIG_FILEOPENPROCS: DWORD = 77;

/// Flag: make the config option thread-specific.
pub const BASS_CONFIG_THREAD: DWORD = 0x40000000;
...
pub const BASS_IOS_SESSION_DISABLE: DWORD = 0x10;
pub const BASS_IOS_SESSION_DEACTIVATE: DWORD = 0x20;
pub const BASS_IOS_SESSION_AIRPLAY: DWORD = 0x40;
pub const BASS_IOS_SESSION_BTHFP: DWORD = 0x80;
pub const BASS_IOS_SESSION_BTA2DP: DWORD = 0x100;

// ─── BASS_Init flags ──────────────────────────────────────────────────────────
pub const BASS_DEVICE_8BITS: DWORD = 1;       // 8 bit (unused)
pub const BASS_DEVICE_MONO: DWORD = 2;        // mono
pub const BASS_DEVICE_3D: DWORD = 4;          // enable 3D (unused)
pub const BASS_DEVICE_16BITS: DWORD = 8;      // limit output to 16 bit
pub const BASS_DEVICE_REINIT: DWORD = 128;    // reinitialize
pub const BASS_DEVICE_LATENCY: DWORD = 0x100; // calculate device latency (unused)
pub const BASS_DEVICE_CPSPEAKERS: DWORD = 0x400; // detect via Windows control panel (unused)
...
pub const BASS_DEVICE_SOFTWARE: DWORD = 0x80000;  // disable hardware/fastpath output
/// Use OpenSL ES output on Android (added in 2.4.17).
pub const BASS_DEVICE_OPENSLES: DWORD = 0x100000;
/// Use Apple Voice Processing for echo cancellation on macOS/iOS (added in 2.4.17).
pub const BASS_DEVICE_APPLEVOICE: DWORD = 0x200000;

// ─── DirectSound object IDs ───────────────────────────────────────────────────
...
/// Default communication device (added in 2.4.17).
...
/// Flag for BASS_GetDeviceInfo: include AirPlay devices.
pub const BASS_DEVICES_AIRPLAY: DWORD = 0x1000000;

// ─── File type constants (replaces the old BOOL mem parameter) ────────────────
// BREAKING (2.4.17): BASS_SampleLoad / BASS_MusicLoad / BASS_StreamCreateFile
// first parameter changed from `BOOL mem` to `DWORD filetype`.
// Old FALSE(0) = BASS_FILE_NAME, old TRUE(1/-1) = BASS_FILE_MEM still work.
pub const BASS_FILE_NAME: DWORD = 0;    // file is a filename
pub const BASS_FILE_MEM: DWORD = 1;     // file points to a memory block
pub const BASS_FILE_MEMCOPY: DWORD = 3; // memory block to copy internally
pub const BASS_FILE_HANDLE: DWORD = 4;  // file is a handle/descriptor
...
pub const BASS_SAMPLE_SOFTWARE: DWORD = 0x10; // unused
pub const BASS_SAMPLE_MUTEMAX: DWORD = 0x20;
pub const BASS_SAMPLE_NOREORDER: DWORD = 0x40;
pub const BASS_SAMPLE_FX: DWORD = 0x80; // unused
...
pub const BASS_MUSIC_FT2PAN: DWORD = 0x2000;
...
pub const BASS_SPEAKER_REAR2: DWORD = BASS_SPEAKER_SIDE;
pub const BASS_SPEAKER_REAR2LEFT: DWORD = BASS_SPEAKER_SIDELEFT;
pub const BASS_SPEAKER_REAR2RIGHT: DWORD = BASS_SPEAKER_SIDERIGHT;

pub const BASS_ASYNCFILE: DWORD = 0x40000000; // read file asynchronously
pub const BASS_UNICODE: DWORD = 0x80000000;   // UTF-16

// ─── Recording flags ─────────────────────────────────────────────────────────
/// Use OpenSL ES recording on Android (added in 2.4.17; was BASS_RECORDOPENSLES in old docs).
pub const BASS_RECORD_OPENSLES: DWORD = 0x1000;
pub const BASS_RECORD_PAUSE: DWORD = 0x8000; // start recording paused
// NOTE: BASS_RECORD_ECHOCANCEL and BASS_RECORD_AGC removed — not in bass.h 2.4.17+.
...
/// Device was suspended/interrupted (added in 2.4.17).
...
/// Download callback (get/set via ChannelSetAttributeEx; added in 2.4.17).
pub const BASS_ATTRIB_DOWNLOADPROC: DWORD = 18;
/// DSP-chain volume level (added in 2.4.17).
pub const BASS_ATTRIB_VOLDSP: DWORD = 19;
/// DSP-chain volume priority (added in 2.4.17).
pub const BASS_ATTRIB_VOLDSP_PRIORITY: DWORD = 20;
/// Per-channel downmix mode (added in 2.4.17).
...
// ─── Channel attribute types (for BASS_ChannelSetAttributeEx typesize) ────────
// BREAKING (2.4.17): Use these constants instead of the literal `4`.
/// 32-bit floating-point value.
pub const BASS_ATTRIBTYPE_FLOAT: c_int = -1;
/// 32-bit integer value.
pub const BASS_ATTRIBTYPE_INT: c_int = -2;

// ─── BASS_ChannelSlideAttribute flags ─────────────────────────────────────────
pub const BASS_SLIDE_LOG: DWORD = 0x1000000;

// ─── BASS_ChannelGetData flags ────────────────────────────────────────────────
// BREAKING (2.4.17): buffer must be NULL when BASS_DATA_AVAILABLE is used.
pub const BASS_DATA_AVAILABLE: DWORD = 0;      // query how much data is buffered
pub const BASS_DATA_NOREMOVE: DWORD = 0x10000000; // flag: don't remove data from recording buffer
pub const BASS_DATA_FIXED: DWORD = 0x20000000; // flag: return 8.24 fixed-point data (unused)
...
pub const BASS_DATA_FFT_INDIVIDUAL: DWORD = 0x10; // FFT flag: per-channel FFT
...
pub const BASS_LEVEL_NOREMOVE: DWORD = 16; // don't remove data from recording buffer
...
/// Fires when a channel attribute changes (added in 2.4.17).
pub const BASS_SYNC_ATTRIB: DWORD = 13;
/// Fires when the output device fails (added in 2.4.17).
pub const BASS_SYNC_DEV_FAIL: DWORD = 14;
/// Fires when the output device format changes (added in 2.4.17).
pub const BASS_SYNC_DEV_FORMAT: DWORD = 15;
/// Raw monotonic byte position sync (added in 2.4.17).
pub const BASS_SYNC_POS_RAW: DWORD = 16;
...
pub const BASS_TAG_ID3V2: DWORD = 1; // variable length block (deprecated; use BINARY variant)
...
pub const BASS_TAG_AM_NAME: DWORD = 16;
pub const BASS_TAG_ID3V2_2: DWORD = 17; // deprecated; use BINARY variant
pub const BASS_TAG_AM_MIME: DWORD = 18;
pub const BASS_TAG_LOCATION: DWORD = 19;
/// ID3v2 tags with length as TAG_BINARY (added in 2.4.17; replaces BASS_TAG_ID3V2).
pub const BASS_TAG_ID3V2_BINARY: DWORD = 20;
/// ID3v2 tags 2nd block with length as TAG_BINARY (added in 2.4.17).
pub const BASS_TAG_ID3V2_2_BINARY: DWORD = 21;
...
pub const BASS_TAG_RIFF_CUE: DWORD = 0x104;
pub const BASS_TAG_RIFF_SMPL: DWORD = 0x105;
pub const BASS_TAG_APE_BINARY: DWORD = 0x1000; // + index # → TAG_APE_BINARY
/// MP4 cover art (added in 2.4.17); + index # → TAG_BINARY.
pub const BASS_TAG_MP4_COVERART: DWORD = 0x1400;
...
pub const BASS_TAG_MUSIC_INST: DWORD = 0x10100; // + instrument #
pub const BASS_TAG_MUSIC_CHAN: DWORD = 0x10200; // + channel #
pub const BASS_TAG_MUSIC_SAMPLE: DWORD = 0x10300; // + sample #
/// Increment channel reference count while reading tags (added in 2.4.17).
pub const BASS_TAG_INCREF: DWORD = 0x20000000;

// ─── BASS_ChannelGetLength / SetPosition / GetPosition modes ─────────────────
pub const BASS_POS_BYTE: DWORD = 0;
pub const BASS_POS_MUSIC_ORDER: DWORD = 1;
pub const BASS_POS_OGG: DWORD = 3;
/// Track number position (added in 2.4.17).
pub const BASS_POS_TRACK: DWORD = 4;
/// Monotonic raw byte position (added in 2.4.17).
pub const BASS_POS_RAW: DWORD = 6;
pub const BASS_POS_END: DWORD = 0x10;
pub const BASS_POS_LOOP: DWORD = 0x11;
/// Get DSP position (added in 2.4.17).
...
// ─── BASS_ChannelSetDSPEx flags (added in 2.4.17) ────────────────────────────
/// DSP is read-only (inspect but don't modify buffer).
pub const BASS_DSP_READONLY: DWORD = 1;
/// Process buffer as floating-point.
pub const BASS_DSP_FLOAT: DWORD = 2;
/// Call DSP proc when the channel is freed.
pub const BASS_DSP_FREECALL: DWORD = 4;
/// DSP is bypassed (also used by BASS_FXSetBypass).
...
// NOTE: BASS_3DALG_FULL (2) and BASS_3DALG_LIGHT (3) removed — not in bass.h 2.4.17+.

// ─── DX7 voice management (VAM) — REMOVED ─────────────────────────────────────
// NOTE: BASS_VAM_* constants removed — not present in bass.h 2.4.17+.

// ─── BASS_SampleGetChannel flags ─────────────────────────────────────────────
pub const BASS_SAMCHAN_NEW: DWORD = 1;
pub const BASS_SAMCHAN_STREAM: DWORD = 2;

// ─── STREAMPROC special return values ────────────────────────────────────────
...
/// Size of async read buffer (added in 2.4.17).
pub const BASS_FILEPOS_ASYNCSIZE: DWORD = 12;

// ─── BASS_ChannelInfo origin resolution flag ─────────────────────────────────
...
/// Load plugin by symbol (static library; iOS legacy). Dynamic libraries don't need this.
pub const BASS_PLUGIN_PROC: DWORD = 1;

// ─── Device notification types (added in 2.4.17) ─────────────────────────────
pub const BASS_DEVICENOTIFY_ENABLED: DWORD = 0;
pub const BASS_DEVICENOTIFY_DEFAULT: DWORD = 1;
pub const BASS_DEVICENOTIFY_REC_DEFAULT: DWORD = 2;
pub const BASS_DEVICENOTIFY_DEFAULTCOM: DWORD = 3;
pub const BASS_DEVICENOTIFY_REC_DEFAULTCOM: DWORD = 4;

// ─── iOS notification types ───────────────────────────────────────────────────
pub const BASS_IOSNOTIFY_INTERRUPT: DWORD = 1;
pub const BASS_IOSNOTIFY_INTERRUPT_END: DWORD = 2;
